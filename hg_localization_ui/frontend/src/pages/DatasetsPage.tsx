...
export const DatasetsPage: React.FC = () => {
  const { data: datasets, isLoading, isFetching, refetch } = useDatasets();
      ...
      <div className="space-y-4 relative">
        ...
        {isFetching && !isLoading && (
          <div className="absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center z-50 rounded-lg">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Refreshing datasets...</p>
            </div>
          </div>
        )}
        ...
        {filteredDatasets.length === 0 ? (
          ...
          filteredDatasets.map((dataset) => {
            ...
            return (
              <div key={datasetKey} className="card hover:shadow-md transition-shadow relative">
                {/* Individual loading mask during cache or download operation */}
                  ...
                  <div className="absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center z-40 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-600">
                        {isDownloading ? 'Caching...' : 'Downloading...'}
                      </p>
                    </div>
                  </div>
                )}
